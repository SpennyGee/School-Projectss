...
public class EventController extends KeyAdapter implements ActionListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		if (!gameOver) {
			...
			// pressing space drops the piece down
			case KeyEvent.VK_SPACE:
				handleMove(Direction.DROP);
				break;
		
			// pressing down arrow key rotates the piece
			case KeyEvent.VK_DOWN:
				game.rotatePiece();
				break;
				
			// pressing left arrow key moves the piece to the left 1 square
			case KeyEvent.VK_LEFT:
				handleMove(Direction.LEFT);
				break;
		
			// pressing right arrow key moves the piece to the right 1 square	
